...
# Train the SimVLA baseline on the current default RMBench product.
# Most day-to-day adjustments should happen in the "Experiment defaults" section below.

ROOT="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)"
SIMVLA_DIR="${ROOT}/third_party/SimVLA"
PRODUCT_DIR="${ROOT}/datasets/product/rmbench_demo_clean_train48_eval2"

# Experiment defaults: update these when you intentionally create a new baseline recipe.
GPU_IDS="0"
OUTPUT_DIR="${ROOT}/outputs/runs/maevla/simvla_baseline"
...
# Training hyperparameters for the baseline run.
LEARNING_RATE="1e-4"
LEARNING_COEF="0.1"
BATCH_SIZE="8"
NUM_ACTIONS="10"
...
# Runtime caches stay under the repo root so the whole workflow remains portable.
