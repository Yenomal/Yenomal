        ...
        **model_kwargs,
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            for i in range(self.config.num_multi_token_pred):
                ...
                if len(next_tokens_all) + generated_len >= generation_config.max_new_tokens:
                    early_stopped = True
                    break
            ...
            generated_len = input_ids.shape[1] - prompt_len
            if next_tokens_all.shape[1] + generated_len >= generation_config.max_new_tokens:
                next_tokens_all = next_tokens_all[:, :generation_config.max_new_tokens - generated_len]
